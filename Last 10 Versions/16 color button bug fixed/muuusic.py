...
class SASPlayer(QMainWindow):
    ...
    def show_color_settings(self):
        ...
        quick_colors_layout.setContentsMargins(0, 0, 0, 0)
        quick_colors_layout.setSpacing(2)

        # Quick colors label
        quick_colors_label = QLabel("⚡ Quick Colors:")
        quick_colors_label.setStyleSheet("color: #ccc; font-size: 12px; font-weight: bold; margin: 0px; padding: 0px;")
        ...
        separator2 = QLabel()
        separator2.setStyleSheet("background-color: #444; height: 1px; margin: 4px 0;")
