...
class MinimalMusicPlayer:
    ...
    def create_ui(self):
        ...
        self.play_toggle_btn = tk.Button(self.controls, text="▶", command=self.toggle_play_pause, state="disabled", **btn_style)
        self.play_toggle_btn.pack(side="left", padx=10)
    ...
    def load_song(self, index):
        ...
        self.play_toggle_btn.config(state="normal", text="⏸")
    ...
    def toggle_play_pause(self):
     if self.player.is_playing():
        self.player.pause()
        self.play_toggle_btn.config(text="▶")
     else:
        self.player.play()
        self.play_toggle_btn.config(text="⏸")
