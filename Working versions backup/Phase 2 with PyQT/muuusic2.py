...
class FAiTHPlayer(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.bg_blur_label.lower()  # Send to bottom
        ...
        self.dark_overlay.lower()  # Still above bg_blur_label

        # ✅ Optional: test this with RED color to verify visibility
        # self.dark_overlay.setStyleSheet("background-color: rgba(255, 0, 0, 100);")  # Debug only
    ...
    def set_album_art(self, image):
        # ✅ Store the original image for reuse if needed
        self.album_original_image = image

        # ✅ Convert original image to QPixmap for album art display
        ...
        # ✅ Create a blurred version only ONCE, store as QPixmap
        ...
        # ✅ Set the scaled blurred pixmap to background label
