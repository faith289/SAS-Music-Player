...
class SleepTimerDialog(QDialog):
    def __init__(self, parent=None, timer_active=False, remaining_min=0, remaining_sec=0):
        ...
        self.setFixedSize(320, 180 if not timer_active else 140)
        self.setStyleSheet("font-size: 14px; background: #232323; border-radius: 12px;")
        self.setWindowTitle("")
        ...
        if timer_active:
            ...
            time_row.setSpacing(0)  # Make buttons closer to the label
            ...
            self.time_display.setStyleSheet("font-size: 24px; font-weight: bold; color: white; padding-left:4px; padding-right:4px;")
            self.plus_btn = QPushButton("+", self)
            self.plus_btn.setFixedSize(28, 28)
            self.plus_btn.setStyleSheet(plusminus_style)
            time_row.addStretch(1)
            time_row.addWidget(self.minus_btn)
            time_row.addSpacing(2)  # Small gap
            ...
            end_row.addWidget(self.end_btn)
            end_row.addStretch(1)
