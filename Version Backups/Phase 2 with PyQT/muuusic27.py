...
class GlowButton(QPushButton):
    ...
    def enterEvent(self, event):
        # 🔁 Create fresh effect every time
...
class FAiTHPlayer(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.brightness_btn.setIcon(QIcon("assets/brightness.png"))
        ...
        # Prevent background labels from intercepting mouse clicks
        ...
        #self.bg_blur_label.setAttribute(Qt.WidgetAttribute.WA_TransparentForMouseEvents)
        ...
        # Set starting opacity for dark overlay
        ...
        self.dark_overlay_opacity_effect.setOpacity(0.6)  # 150/255 default
        ...
        for btn in (self.vol_down_btn, self.vol_up_btn):
    ...
    def toggle_darkness(self):
        ...
        current_opacity = self.dark_overlay.graphicsEffect().opacity() if self.dark_overlay.graphicsEffect() else 1.0
