...
from PyQt6.QtGui import QPixmap, QImage, QFont, QColor, QPalette, QIcon, QPainter, QBrush, QPen
from PyQt6.QtCore import Qt, QTimer, pyqtSignal, pyqtSlot, QRect
import vlc
...
class FAiTHPlayer(QMainWindow):
        ...
        self.seek_slider.setStyleSheet("""
            ...
            QSlider::sub-page:horizontal {
                background: qlineargradient(
                    x1:0, y1:0, x2:1, y2:0,
                    stop:0 rgba(30, 120, 80, 160),
                    stop:1 rgba(100, 255, 180, 160)
                );
                border-radius: 4px;
            }
        """)
    ...
    def load_song(self, index):
        ...
        current_item.setForeground(QColor("#f5faf6"))  # Spotify green
